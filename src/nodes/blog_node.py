...
class BlogNode:
    ...
    def translation(self, state : BlogState):
        """
        Translate the content to the specified format.
        ...
        messages = [
                ...
                HumanMessage(translation_prompts.format(current_language = state["current_language"], blog_content = blog_content))
